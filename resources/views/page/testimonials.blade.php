...
@section('content')
    ...
    <div class="container margin-top-60">
        <div class="row margin-bottom-20">
            <div class="section-title-1 tx-center margin-bottom-30 os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
                <h2 class="color-orange-2"><strong>More than 2000 GREAT testimonials</strong></h2>
                {{--<h4><b>“Better Hotels and superior Service at the best price”</b></h4>--}}
                <div class="sec-title-div-1"></div>
                <p>Every year, we receive hundreds of reviews from our satisfied customers letting us know what a great time they had on their Latin America vacations. We are proud to say that we have over 2,000 outstanding Peru For Less reviews!Every year, we receive hundreds of reviews from our satisfied customers letting us know what a great time they had on their Latin America vacations. We are proud to say that we have over 2,000 outstanding Peru For Less reviews!</p>
                <p>So how do we do it? How do we manage to be one of the travel agencies with the best testimonials in the world? Ever heard of Kant’s Kingdom of Ends or the Samurai Code of Ethics? Well, we work hard, we enjoy serving you, and we see you as an end in itself.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row margin-bottom-20">
            <div class="section-title-1 margin-bottom-30 os-animation well" data-os-animation="fadeInUp" data-os-animation-delay="0s">
